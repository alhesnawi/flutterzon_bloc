...
String adminUpdateProductFlagsUri = '$uri/admin/update-product-flags';
String adminLowStockProductsUri = '$uri/admin/low-stock-products';
String adminUpdateStockThresholdUri = '$uri/admin/update-stock-threshold';
String adminDuplicateProductUri = '$uri/admin/duplicate-product';
String adminUpdateProductStockUri = '$uri/admin/update-product-stock';
String featuredProductsUri = '$uri/api/products/featured';
String trendingProductsUri = '$uri/api/products/trending';
